Shader "Universal Render Pipeline/Terrain/StochasticTerrain"
{
    Properties
    {
        ...
        HLSLINCLUDE
                ...
                SubShader
            {
                ...
                #include "StochasticTerrainPasses.hlsl"
                ENDHLSL
            }
            ...
            Pass
            {
                ...
                Dependency "AddPassShader" = "Hidden/Universal Render Pipeline/Terrain/StochasticTerrain (Add Pass)"
